...
# Modification of https://github.com/shishishu/pytorch-captcha-recognition/blob/master/dataset.py
...
class Captcha(data.Dataset):
    def __init__(self, directory, ImageHeight = 32, ImageWidth = 32, train=True):
        self.imgsPath = [os.path.join(directory, img) for img in find_png_filenames(directory)]
...
if __name__ == '__main__':
    demoDataset = Captcha('testdata/',24,64, train=True)
    print(demoDataset.__getitem__(0))